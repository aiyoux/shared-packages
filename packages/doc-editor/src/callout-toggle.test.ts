import { findBlock, plaintextOf, visibleOrder } from '@shared-packages/doc-model';
...
describe('N2 callout/toggle editor', () => {
	...
	it('DocEditor: one host, overlay stays in the gutter, drag-select child → following paragraph', async () => {
	...
	it('DocEditor chrome handle height equals chrome offsetHeight', async () => {
