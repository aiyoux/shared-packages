 ...
 *
 * Both names are returned together, from a single call, on purpose. If two code
 ...
 * suffixes are for debuggability rather than collision-avoidance.
 */
...
/**
 * Derive both names for a document. Throws on an empty id rather than
 * returning a name that would quietly pair every id-less caller together —
 * a loud failure here is the whole point of funnelling through one function.
 */
